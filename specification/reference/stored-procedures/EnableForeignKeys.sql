...
BEGIN
  ...
  DECLARE getFKs CURSOR FOR
    SELECT CAST(fk.name AS nvarchar) fkname, N'ALTER TABLE [dbo].[' + CAST(o.name AS nvarchar) + N'] WITH CHECK CHECK CONSTRAINT ' + CAST(fk.name AS nvarchar) + N';' disableFK	   
	...
	WHERE fk.name NOT IN ('FKSubCategor747583','FKExpression885924','FKOperationV331822','FKOperAttrVa233236')
