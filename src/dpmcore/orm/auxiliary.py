...
class AuxCellMapping(Base):
    ...
    old_cell_id: Mapped[Optional[int]] = mapped_column(
        "OldCellID", Integer
    )
...
class AuxCellStatus(Base):
    ...
    is_new_cell: Mapped[Optional[bool]] = mapped_column(
        "IsNewCell", Boolean
    )
...
class ModelViolations(Base):
    ...
    violation: Mapped[Optional[str]] = mapped_column(
        "Violation", String(255)
    )
    is_blocking: Mapped[Optional[bool]] = mapped_column(
        "isBlocking", Boolean
    )
    ...
    table_code: Mapped[Optional[str]] = mapped_column(
        "TableCode", String(40)
    )
    ...
    key_header: Mapped[Optional[bool]] = mapped_column(
        "KeyHeader", Boolean
    )
    ...
    header_subcategory_id: Mapped[Optional[int]] = (
        mapped_column("HeaderSubcategoryID", Integer)
    )
    header_subcategory_name: Mapped[Optional[str]] = (
        mapped_column("HeaderSubcategoryName", String(60))
    )
    ...
    cell2_id: Mapped[Optional[int]] = mapped_column(
        "Cell2ID", Integer
    )
    cell2_code: Mapped[Optional[str]] = mapped_column(
        "Cell2Code", String(50)
    )
    vv_end_release_id: Mapped[Optional[int]] = mapped_column(
        "VVEndReleaseID", Integer
    )
    new_aspect: Mapped[Optional[str]] = mapped_column(
        "NewAspect", String(80)
    )
